...
export default function FloatingThemeToggle({ className }: { className?: string }) {
  ...
  return (
    <div className={className || "fixed bottom-6 right-6 z-50 hover:scale-105 transition-transform"}>
